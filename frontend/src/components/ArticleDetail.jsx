  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="mt-16 pt-8">
        ...
        <form className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg mb-10 border border-gray-100 dark:border-gray-700" onSubmit={handleSubmit(onSubmitComment)}>
